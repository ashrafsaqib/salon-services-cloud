              ...
              <div className="flex flex-wrap gap-2">
                {categories.map(cat => (
                  <a
                    ...
                    className={`px-4 py-2 rounded bg-gray-100 hover:bg-rose-100 text-gray-700 font-medium border ${categoryId == String(cat.id) ? "border-rose-500 bg-rose-50" : "border-gray-200"}`}
                  >
                    {cat.title}
                  </a>
                ))}
